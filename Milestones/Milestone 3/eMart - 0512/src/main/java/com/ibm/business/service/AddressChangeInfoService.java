...
public interface AddressChangeInfoService {
     ...
     */
	public RemoteApiServerResponse<AddressChangeListRes> getAddressInfo(HeaderInfoRes headerInfo, String searchType, String searchKey, String maxRowNumber);
     ...
     */
	public RemoteApiServerResponse<AddressAndPhoneNumberListRes> getAddressOrTelephoneInfo(HeaderInfoRes headerInfo);
     ...
     */
	public RemoteApiServerResponse<ReceiptNumberInfoRes> sendAddressOrTelephoneAcceptInfo(HeaderInfoRes headerInfo, AddressPhonenumberReq request);
